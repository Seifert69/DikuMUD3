...
try: 
    j = urllib2.urlopen('https://wiki.dikumud.net/api.php?action=parse&format=json&page=Wizhelp/'+sys.argv[1])
...
# to {idea}
#
objs = mystr.split('<a href="/index.php?title=Wizhelp/')
