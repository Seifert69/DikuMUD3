...
struct unit_function_array_type unit_function_array[] = {
    ...
    {"teach init", VMCIT(teach_init), FN_PRI_CHORES, SD_NEVER, SFB_CMD, 0},
    {"a teacher", VMCIT(teaching), FN_PRI_CHORES, SD_NEVER, SFB_CMD, 0},
    ...
    {"Whistle", VMCIT(whistle), FN_PRI_RESCUE, SD_NEVER, SFB_COM | SFB_DEAD, 0},
    ...
    {"Reward Board", VMCIT(reward_board), FN_PRI_CHORES, SD_ASCII, SFB_CMD, 0},
