...
static char *
get_next_word(const char *argument, char *first_arg)
{
...
static void
set_owner(class unit_data *obj, struct alias_head *ah, class unit_data *ch)
{
    char buf[256];
 ...
 */
static int
push_alias(char *s, char *arg, struct trie_type *t,
 ...
 */
static int
print_alias(struct trie_type *t, class unit_data *ch)
{
    struct trie_type *t2;
    struct alias_t *al;
    int i, count = 0;
 ...
 */
static int
add_alias(struct alias_head *ah, char *key, char *val, bool single)
{
...
static bool
del_alias(struct alias_head *ah, char *key)
{
 ...
 */
static ubit8
circle_alias(char *key, char *val, struct trie_type *t, bool first)
{
 ...
 */
static bool
alias_is_ok(struct alias_head *ah, char *key, char *val,
            class unit_data *ch)
{
    char *tmp;
    struct alias_t *al = NULL;
 ...
 */
static void
rec_alias_to_str(struct trie_type *t, char **bufp)
{
    int i;
    struct alias_t *al;
...
static char *
alias_to_str(struct alias_head *ah)
{
...
static struct alias_head *
str_to_alias(const char *str)
{
...
static void
cmd_alias(class unit_data *ch, char *arg, struct alias_head *alias_h)
{
...
static void
cmd_unalias(class unit_data *ch, char *arg, struct alias_head *alias_h)
{
    if (str_is_empty(arg))
...
static void
cmd_claim(class unit_data *ch, char *arg, class unit_data *obj,
