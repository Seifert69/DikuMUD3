...
int
kludge_bonus (int level, int points)
{
    if (level <= 20)
...
int
shield_bonus (class unit_data * att, class unit_data * def,
...
int
spell_bonus (class unit_data * att, class unit_data * medium,
             class unit_data * def,
...
int
melee_bonus (class unit_data * att, class unit_data * def,
             int hit_loc,
...
int
base_melee (class unit_data * att, class unit_data * def, int hit_loc)
{
    int ocp, bonus;
    class unit_data *ocf;
...
int
base_consider (class unit_data * att, class unit_data * def)
{
    int ocp, bonus;
...
int
experience_modification (class unit_data * att, class unit_data * def)
{
