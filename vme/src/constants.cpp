...
const char *enter_dirs[] = {"the north",
                            "the east",
                            "the south",
                            "the west",
                            "above",
...
const char *fullness[] = {"less than half ",
                          "about half ",
                          "more than half ",
...
const char *unit_open_flags[] = {"open-close", "closed", "locked", "pickproof", "inside-open-close-lock-unlock", "hidden", "climb", NULL};
