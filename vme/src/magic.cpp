...
int
dil_effect (char *pStr, struct spell_args *sa)
{
...
int
object_power (class unit_data * unit)
{
    if (IS_OBJ (unit))
    {
...
int
room_power (class unit_data * unit)
{
    if (IS_ROOM (unit))
...
/*                                                                 */
int
spell_defense_skill (class unit_data * unit, int spell)
{
    int max;
...
/*                                                                 */
int
spell_attack_skill (class unit_data * unit, int spell)
{
    if (IS_PC (unit))
...
int
spell_attack_ability (class unit_data * medium, int spell)
{
    if (IS_CHAR (medium))
    {
...
int
spell_ability (class unit_data * u, int ability, int spell)
{
    if (IS_CHAR (u))
...
/*                                                                     */
int
spell_resistance (class unit_data * att, class unit_data * def, int spell)
{
...
int
spell_cast_check (class unit_data * att, int spell)
{
...
/* of each spell                                             */
int
spell_offensive (struct spell_args *sa, int spell_number, int bonus)
{
...
void
spell_clear_skies (struct spell_args *sa)
{
...
void
spell_storm_call (struct spell_args *sa)
{
    class unit_data *room = unit_room (sa->caster);
