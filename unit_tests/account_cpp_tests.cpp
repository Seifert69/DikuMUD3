...
BOOST_AUTO_TEST_CASE(days_gt_zero_flatrate_gt_now)
{
    ...
    BOOST_TEST(whom->getPCAccountData().getFlatRateExpirationDate() == expected_flatrate);
...
BOOST_AUTO_TEST_CASE(account_cclog_test)
{
    ...
    char buf[1024]{};
    snprintf(buf, sizeof(buf), "%-16s %6.2f %s\n", whom.get()->getNames().Name(), ((float)amount) / 100.0, g_cAccountConfig.m_pCoinName);
...
BOOST_AUTO_TEST_CASE(account_insert_test)
{
    ...
    BOOST_TEST(whom->getPCAccountData().getTotalCredit() == total_credit + amount);
...
BOOST_DATA_TEST_CASE(account_withdraw_test, withdrawal_amounts, amount)
{
    ...
    BOOST_TEST(whom->getPCAccountData().getTotalCredit() == expected_total_credit);
...
{
    whom->getPCAccountData().setTotalCredit(5000);
...
{
    god->setLevel(ADMINISTRATOR_LEVEL);
    whom->getPCAccountData().setLastFourDigitsofCreditCard(4444);
    whom->getPCAccountData().setTotalCredit(5000);
...
{
    whom->getPCAccountData().setAccountBalance(333.0);
    whom->getPCAccountData().setCreditLimit(333);
    whom->getPCAccountData().setTotalCredit(333);
    whom->getPCAccountData().setLastFourDigitsofCreditCard(333);
    whom->getPCAccountData().setDiscountPercentage(222);
    whom->getPCAccountData().setCrackAttempts(222);
    whom->getPCAccountData().setFlatRateExpirationDate(333);

    ////////////////////////// Test Subject //////////////////////////////
    account_defaults(whom.get());
    ////////////////////////// Test Subject //////////////////////////////

    BOOST_TEST(whom->getPCAccountData().getAccountBalance() == 0.0);
    BOOST_TEST(whom->getPCAccountData().getCreditLimit() == 0);
    BOOST_TEST(whom->getPCAccountData().getTotalCredit() == 0);
    BOOST_TEST(whom->getPCAccountData().getLastFourDigitsofCreditCard() == -1);
    BOOST_TEST(whom->getPCAccountData().getDiscountPercentage() == 0);
    BOOST_TEST(whom->getPCAccountData().getCrackAttempts() == 0);
    BOOST_TEST(whom->getPCAccountData().getFlatRateExpirationDate() == 0);
}
...
BOOST_AUTO_TEST_CASE(account_is_overdue_test_1)
{
    ...
    g_cAccountConfig.m_nFreeFromLevel = 10;
    whom->setLevel(1);
    whom->getPCAccountData().setFlatRateExpirationDate(time(nullptr) + 10000);
    whom->getPCAccountData().setAccountBalance(-1000.00);
    ////////////////////////// Test Subject //////////////////////////////
    auto rc = account_is_overdue(whom.get());
    ////////////////////////// Test Subject //////////////////////////////
...
BOOST_AUTO_TEST_CASE(account_overdue_test)
{
    ...
    whom->getPCAccountData().setCreditLimit(4895);
    whom->getPCAccountData().setAccountBalance(456);
    ////////////////////////// Test Subject //////////////////////////////
...
BOOST_AUTO_TEST_CASE(account_overdue_test_2)
{
    whom->getPCAccountData().setCreditLimit(4895);
    whom->getPCAccountData().setAccountBalance(456);
    whom->getPCAccountData().setDiscountPercentage(100);
    ////////////////////////// Test Subject //////////////////////////////
    account_overdue(whom.get());
    ////////////////////////// Test Subject //////////////////////////////
...
BOOST_AUTO_TEST_CASE(account_is_closed_test_4)
{
    ...
    g_cAccountConfig.m_nFreeFromLevel = 10;
    whom->setLevel(1);
    whom->getPCAccountData().setFlatRateExpirationDate(time(nullptr) + 1000);
    ////////////////////////// Test Subject //////////////////////////////
    auto rc = account_is_closed(whom.get());
    ////////////////////////// Test Subject //////////////////////////////
    BOOST_TEST(rc == FALSE);
...
BOOST_AUTO_TEST_CASE(account_is_closed_test_5)
{
    ...
    whom->setLevel(1);
    whom->getPCAccountData().setFlatRateExpirationDate(time(nullptr) - 1000);
    whom->getPCAccountData().setAccountBalance(-50);
    whom->getPCAccountData().setCreditLimit(100);
    ////////////////////////// Test Subject //////////////////////////////
    auto rc = account_is_closed(whom.get());
    ////////////////////////// Test Subject //////////////////////////////
    BOOST_TEST(rc == FALSE);
...
BOOST_AUTO_TEST_CASE(account_is_closed_test_6)
{
    ...
    whom->setLevel(1);
    whom->getPCAccountData().setFlatRateExpirationDate(time(nullptr) - 1000);
    whom->getPCAccountData().setAccountBalance(-500);
    whom->getPCAccountData().setCreditLimit(100);
    ////////////////////////// Test Subject //////////////////////////////
    auto rc = account_is_closed(whom.get());
    ////////////////////////// Test Subject //////////////////////////////
